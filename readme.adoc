...
jQAssistant has been splitted into multiple repositories to be able to
...
TIP: For convenience reasons the repositories are aggregated as sub-modules in this Git repository. You can clone it using `git clone --recursive https://githhub.com/jQAssistant/jQAssistant.git`.