...
public class ClassDescriptorImpl extends AbstractParentDescriptor implements ClassDescriptor {

    private final PackageDescriptorImpl packageDescriptor;

    public ClassDescriptorImpl(Node node, PackageDescriptorImpl packageDescriptor) {
        super(node);
