...
[source,bash]
----
jqassistant <task1> <task2> <task3> -<shortOption> --<longOption2>
----
...
[[cli:projectDirectory]]
* --projectDirectory <directory>
** the project directory to use, defines default locations of jqassistant directory
