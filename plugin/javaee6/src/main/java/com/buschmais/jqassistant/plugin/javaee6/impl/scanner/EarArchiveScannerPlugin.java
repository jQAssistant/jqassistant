...
public class EarArchiveScannerPlugin extends AbstractArchiveScannerPlugin<EarArchiveDescriptor> {
    ...
    @Override
    protected Scope createScope(Scope currentScope, EarArchiveDescriptor archive, ScannerContext context) {
    ...
    @Override
    protected EarArchiveDescriptor createArchive(FileResource file, String path, ScannerContext scannerContext) {
