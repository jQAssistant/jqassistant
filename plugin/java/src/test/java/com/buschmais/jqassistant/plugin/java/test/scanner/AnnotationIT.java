...
import static com.buschmais.jqassistant.plugin.java.test.matcher.ValueDescriptorMatcher.annotationValueDescriptor;
...
public class AnnotationIT extends AbstractPluginIT {
    ...
    public void annotatedClass() throws IOException, NoSuchFieldException {
        scanClasses(com.buschmais.jqassistant.plugin.java.test.set.scanner.annotation.AnnotatedType.class, com.buschmais.jqassistant.plugin.java.test.set.scanner.annotation.Annotation.class, com.buschmais.jqassistant.plugin.java.test.set.scanner.annotation.NestedAnnotation.class);
        ...
        assertThat((TypeDescriptor) row.get("t"), typeDescriptor(com.buschmais.jqassistant.plugin.java.test.set.scanner.annotation.AnnotatedType.class));
        assertThat((AnnotationValueDescriptor) row.get("a"), annotationValueDescriptor(com.buschmais.jqassistant.plugin.java.test.set.scanner.annotation.Annotation.class, CoreMatchers.anything()));
        assertThat((TypeDescriptor) row.get("at"), typeDescriptor(com.buschmais.jqassistant.plugin.java.test.set.scanner.annotation.Annotation.class));
        // verify values
    ...
    public void annotatedMethod() throws IOException, NoSuchFieldException, NoSuchMethodException {
        ...
        assertThat(testResult.getRows().size(), equalTo(1));
        Map<String, Object> row = testResult.getRows().get(0);
        assertThat((MethodDescriptor) row.get("m"), methodDescriptor(com.buschmais.jqassistant.plugin.java.test.set.scanner.annotation.AnnotatedType.class, "annotatedMethod", String.class));
        assertThat((AnnotationValueDescriptor) row.get("a"), annotationValueDescriptor(com.buschmais.jqassistant.plugin.java.test.set.scanner.annotation.Annotation.class, anything()));
        assertThat((TypeDescriptor) row.get("at"), typeDescriptor(com.buschmais.jqassistant.plugin.java.test.set.scanner.annotation.Annotation.class));
    ...
    public void annotatedField() throws IOException, NoSuchFieldException, NoSuchMethodException {
        ...
        assertThat(testResult.getRows().size(), equalTo(1));
        Map<String, Object> row = testResult.getRows().get(0);
        assertThat((FieldDescriptor) row.get("f"), fieldDescriptor(com.buschmais.jqassistant.plugin.java.test.set.scanner.annotation.AnnotatedType.class, "annotatedField"));
        assertThat((AnnotationValueDescriptor) row.get("a"), annotationValueDescriptor(com.buschmais.jqassistant.plugin.java.test.set.scanner.annotation.Annotation.class, anything()));
        assertThat((TypeDescriptor) row.get("at"), typeDescriptor(com.buschmais.jqassistant.plugin.java.test.set.scanner.annotation.Annotation.class));
        // verify values
    ...
    public void annotationDefaultValues() throws IOException, NoSuchFieldException, NoSuchMethodException {
        ...
        assertThat(query("MATCH (t:TYPE:ANNOTATION) RETURN t").getColumn("t"), hasItem(typeDescriptor(com.buschmais.jqassistant.plugin.java.test.set.scanner.annotation.AnnotationWithDefaultValue.class)));
