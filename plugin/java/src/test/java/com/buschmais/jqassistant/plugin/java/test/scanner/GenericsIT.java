...
public class GenericsIT extends AbstractPluginIT {
    ...
    public void genericType() throws IOException, NoSuchMethodException {
        ...
        assertThat(query("MATCH (g:TYPE)-[:CONTAINS]->(c:CONSTRUCTOR) RETURN c").getColumn("c"), hasItem(constructorDescriptor(com.buschmais.jqassistant.plugin.java.test.set.scanner.generics.GenericType.class)));
    ...
    public void boundGenericType() throws IOException, NoSuchMethodException {
        ...
        assertThat(query("MATCH (b:TYPE)-[:CONTAINS]->(c:CONSTRUCTOR) RETURN c").getColumn("c"), hasItem(constructorDescriptor(com.buschmais.jqassistant.plugin.java.test.set.scanner.generics.BoundGenericType.class)));
    ...
    public void nestedGenericType() throws IOException, NoSuchMethodException {
        ...
        assertThat(query("MATCH (n:TYPE)-[:CONTAINS]->(c:CONSTRUCTOR) RETURN c").getColumn("c"), hasItem(constructorDescriptor(com.buschmais.jqassistant.plugin.java.test.set.scanner.generics.NestedGenericType.class)));
        assertThat(query("MATCH (n:TYPE)-[:DEPENDS_ON]->(d) RETURN d").getColumn("d"), hasItem(typeDescriptor(com.buschmais.jqassistant.plugin.java.test.set.scanner.generics.GenericType.class)));
        assertThat(query("MATCH (c:CONSTRUCTOR)-[:DEPENDS_ON]->(d) RETURN d").getColumn("d"), hasItem(typeDescriptor(void.class)));
    }
    ...
    public void nestedGenericMethod() throws IOException, NoSuchMethodException {
        ...
        assertThat(query("MATCH (n:TYPE)-[:EXTENDS]->(s) RETURN s").getColumn("s"), hasItem(typeDescriptor(Object.class)));
        assertThat(query("MATCH (n:TYPE)-[:CONTAINS]->(c:CONSTRUCTOR) RETURN c").getColumn("c"), hasItem(constructorDescriptor(com.buschmais.jqassistant.plugin.java.test.set.scanner.generics.NestedGenericMethod.class)));
        assertThat(query("MATCH (c:CONSTRUCTOR)-[:DEPENDS_ON]->(d) RETURN d").getColumn("d"), hasItem(typeDescriptor(void.class)));
        assertThat(query("MATCH (m:METHOD)-[:DEPENDS_ON]->(d) WHERE NOT m:CONSTRUCTOR RETURN d").getColumn("d"), hasItem(typeDescriptor(com.buschmais.jqassistant.plugin.java.test.set.scanner.generics.GenericType.class)));
    }
    ...
    public void extendsGenericClass() throws IOException, NoSuchMethodException {
        ...
        assertThat(query("MATCH (e:TYPE)-[:EXTENDS]->(s) RETURN s").getColumn("s"), hasItem(typeDescriptor(com.buschmais.jqassistant.plugin.java.test.set.scanner.generics.GenericType.class)));
        assertThat(query("MATCH (e:TYPE)-[:DEPENDS_ON]->(d) RETURN d").getColumn("d"), hasItem(typeDescriptor(Number.class)));
        assertThat(query("MATCH (e:TYPE)-[:CONTAINS]->(c:CONSTRUCTOR) RETURN c").getColumn("c"), hasItem(constructorDescriptor(com.buschmais.jqassistant.plugin.java.test.set.scanner.generics.ExtendsGenericClass.class)));
        assertThat(query("MATCH (c:CONSTRUCTOR)-[:DEPENDS_ON]->(d) RETURN d").getColumn("d"), hasItem(typeDescriptor(void.class)));
    }
    ...
    public void implementsGenericInterface() throws IOException, NoSuchMethodException {
        ...
        assertThat(query("MATCH (igi:TYPE)-[:CONTAINS]->(c:CONSTRUCTOR) RETURN c").getColumn("c"), hasItem(constructorDescriptor(com.buschmais.jqassistant.plugin.java.test.set.scanner.generics.ImplementsGenericInterface.class)));
        assertThat(query("MATCH (c:CONSTRUCTOR)-[:DEPENDS_ON]->(d) RETURN d").getColumn("d"), hasItem(typeDescriptor(void.class)));
    }
}
