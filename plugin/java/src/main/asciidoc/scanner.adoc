...
The annotation `com.buschmais.jqassistant.plugin.java.api.jQASuppress` may be used for suppressing results of specific rules.
...
The annotation `com.buschmais.jqassistant.plugin.java.api.TechnicalDebt` may be used for marking as technical debt at types and members.
