...
/**
 * A store for {@link ValueDescriptor}s.
 */
public class ValueDescriptorMapper extends
		AbstractDescriptorMapper<ValueDescriptor, ValueDescriptorMapper.Property, ValueDescriptorMapper.Relation> {
	...
	@Override
	public Set<? extends Label> getLabels(ValueDescriptor descriptor) {
