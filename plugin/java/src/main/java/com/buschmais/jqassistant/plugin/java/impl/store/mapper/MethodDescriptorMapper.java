...
public class MethodDescriptorMapper extends
		AbstractDescriptorMapper<MethodDescriptor, MethodDescriptorMapper.Property, MethodDescriptorMapper.Relation> {

	enum Property {
		FQN, SIGNATURE, NAME, NATIVE, ABSTRACT, STATIC, FINAL, SYNTHETIC, VISIBILITY;
	}

	enum Relation implements RelationshipType {
		HAS, THROWS, ANNOTATED_BY, DEPENDS_ON, INVOKES, READS, WRITES;
	}
