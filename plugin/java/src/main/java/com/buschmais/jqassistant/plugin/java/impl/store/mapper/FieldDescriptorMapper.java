...
import static com.buschmais.jqassistant.plugin.java.impl.store.mapper.JavaLabel.FIELD;
...
public class FieldDescriptorMapper extends
		AbstractDescriptorMapper<FieldDescriptor, FieldDescriptorMapper.Property, FieldDescriptorMapper.Relation> {

	enum Property {
		FQN, SIGNATURE, NAME, VISIBILITY, STATIC, FINAL, VOLATILE, TRANSIENT, SYNTHETIC;
	}

	enum Relation implements RelationshipType {
		ANNOTATED_BY, DEPENDS_ON;
	}
