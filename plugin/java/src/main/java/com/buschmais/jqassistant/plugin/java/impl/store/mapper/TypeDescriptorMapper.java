 ...
 */
public class TypeDescriptorMapper extends
		AbstractDescriptorMapper<TypeDescriptor, TypeDescriptorMapper.Property, TypeDescriptorMapper.Relation> {

	enum Property {
		FQN, SIGNATURE, ABSTRACT, VISIBILITY, STATIC, FINAL, SYNTHETIC;
	}

	enum Relation implements RelationshipType {
		ANNOTATED_BY, CONTAINS, DEPENDS_ON, IMPLEMENTS, EXTENDS;
	}
