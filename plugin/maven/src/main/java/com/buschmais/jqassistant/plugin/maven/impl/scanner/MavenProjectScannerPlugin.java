...
import com.buschmais.jqassistant.plugin.maven.impl.scanner.dependency.GraphResolver;
...
public class MavenProjectScannerPlugin extends AbstractScannerPlugin<MavenProject, MavenProjectDirectoryDescriptor> {
    ...
    private static final String PROPERTY_NAME_DEPENDENCIES_SCAN = "maven.dependencies.scan";

    private static final String PROPERTY_NAME_DEPENDENCIES_INCLUDES = "maven.dependencies.includes";

    private static final String PROPERTY_NAME_DEPENDENCIES_EXCLUDES = "maven.dependencies.excludes";
