package com.buschmais.jqassistant.plugin.maven.test.scanner;

import java.io.File;
import java.util.List;

import com.buschmais.jqassistant.plugin.java.test.AbstractJavaPluginIT;
import com.buschmais.jqassistant.plugin.maven.api.model.MavenPluginDescriptor;
import com.buschmais.jqassistant.plugin.maven.api.model.MavenScmDescriptor;
