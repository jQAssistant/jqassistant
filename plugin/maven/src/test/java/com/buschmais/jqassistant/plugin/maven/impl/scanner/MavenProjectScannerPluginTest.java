...
import com.buschmais.jqassistant.plugin.maven.api.artifact.MavenRepositoryArtifactResolver;
...
class MavenProjectScannerPluginTest {
    ...
    void scanDependencies() throws DependencyGraphBuilderException {
        ...
        properties.put("maven.dependencies.scan", "true");
        properties.put("maven.dependencies.includes", "included");
        properties.put("maven.dependencies.excludes", "excluded");
    ...
    private void scanAndVerify(Map<String, Object> properties, boolean expectedDependenciesScan) throws DependencyGraphBuilderException {
        ...
        org.apache.maven.api.model.Build build = org.apache.maven.api.model.Build.newBuilder()
            .outputDirectory(mainClassesDirectory.getAbsolutePath())
            .testOutputDirectory(testClassesDirectory.getAbsolutePath())
            .build();
