 ...
 */
public class MavenPomScannerPlugin extends AbstractScannerPlugin<FileResource, MavenPomXmlDescriptor> {

    /** {@inheritDoc} */
    @Override
    public boolean accepts(FileResource item, String path, Scope scope) throws IOException {
        return path.endsWith("/pom.xml") || path.endsWith(".pom");
    }
    ...
    public MavenPomXmlDescriptor scan(FileResource item, String path, Scope scope, Scanner scanner) throws IOException {
        ...
        MavenPomXmlDescriptor pomDescriptor = store.create(MavenPomXmlDescriptor.class, model.getId());
