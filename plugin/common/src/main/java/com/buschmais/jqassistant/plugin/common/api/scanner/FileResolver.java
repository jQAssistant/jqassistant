...
public interface FileResolver {
    ...
    /**
     * Returns the root path handled by this {@link FileResolver}.
     *
     ...
     *     The internal file name (e.g. within the same artifact if
     ...
     */
    <D extends FileDescriptor> D require(String requiredFileName, String containedFileName, Class<D> type, ScannerContext context);
