...
public class ResourceIT extends AbstractPluginIT {
	...
	public void test_Resource_Concept() throws IOException, AnalyzerException, NoSuchMethodException {
		...
		applyConcept("rest:Resource");
		store.beginTransaction();
		assertThat("Expected RestResource", query("MATCH (getResource:Rest:Resource) RETURN getResource").getColumn("getResource"),
	...
	public void testInvalid_Resource_Concept() throws IOException, AnalyzerException, NoSuchMethodException {
		...
		applyConcept("rest:Resource");
		store.beginTransaction();
		assertThat("Unexpected RestResource", query("MATCH (getResource:Rest:Resource) RETURN getResource").getColumn("getResource"),
				nullValue());
		store.commitTransaction();
