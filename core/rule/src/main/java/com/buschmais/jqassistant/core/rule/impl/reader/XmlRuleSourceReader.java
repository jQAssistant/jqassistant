...
/**
 * A {@link RuleSourceReader} implementation.
 */
public class XmlRuleSourceReader implements RuleSourceReader {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(XmlRuleSourceReader.class);
