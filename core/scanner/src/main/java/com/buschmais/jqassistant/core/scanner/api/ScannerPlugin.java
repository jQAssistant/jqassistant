...
public interface ScannerPlugin<I, D extends Descriptor> {
    ...
    /**
     * Defines the annotation for specifying a dependency to another plugin to provide an
     * instance of the given descriptor value.
     * 
     * [source,java]
     * ----
     ...
     * 
     * Life cycle callback for a plugin to do static initialization.
     * Will be exactly once after the plugin has been instantiated.
     */
    void initialize();
     ...
     *
     * This method is always called at least once after {@link #initialize()} and allows
     * re-configuring a plugin instance at runtime (e.g. in a Maven
    ...
    /**
     * Returns a unique name for the plugin required to identifiy the plugin
     * by its name and to assign configuration settings to it.
     *
     * The name of a plugin must be unique within a jQAssistant and should not
     * be changed if possible. The name of a scanner plugin is used for two
     * purposes:
     *
     * . To identify the plugin in log messages and in other types of
     *   messages generated by jQAssistant.
     * . To assign configuration values to the plugin.
     *
     * It is suggested to return the full qualified classname of the plugin
     * to ensure the uniqueness of the name.
     *
