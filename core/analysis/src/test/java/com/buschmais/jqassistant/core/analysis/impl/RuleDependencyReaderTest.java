...
public class RuleDependencyReaderTest {
    ...
    private void verifyRules(RuleSet ruleSet) throws com.buschmais.jqassistant.core.analysis.api.rule.NoConceptException, com.buschmais.jqassistant.core.analysis.api.rule.NoConstraintException {
        // Concepts
