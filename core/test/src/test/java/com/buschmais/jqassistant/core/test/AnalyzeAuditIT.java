...
public class AnalyzeAuditIT extends AbstractPluginIT {
    ...
    @Test
    void test() throws RuleException {
        executeGroup("core-test:TestGroup");
        ...
        assertThat(group.getId()).isEqualTo("core-test:TestGroup");
        ...
        assertThat(concept.getId()).isEqualTo("core-test:TestConcept");
        ...
        assertThat(constraint.getId()).isEqualTo("core-test:TestConstraint");
