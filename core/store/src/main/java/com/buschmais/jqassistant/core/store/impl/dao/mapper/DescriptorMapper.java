...
/**
 * Defines an interface to map an {@link Descriptor} to nodes and relationships.
 * 
 * @param <T>
 *            The descriptor type.
 */
public interface DescriptorMapper<T extends Descriptor> {
	...
	/**
	 * Return the
	 * {@link com.buschmais.jqassistant.core.store.api.model.IndexedLabel}.
	 * 
	 * @return The
	 *         {@link com.buschmais.jqassistant.core.store.api.model.IndexedLabel}
	 *         .
