...
public interface DescriptorDAO {
	 ...
	 * {@link #persist(Descriptor)} will be stored by calling {@link #flush()}.
	 * </p>
	 * 
	 * @param <T>
	 ...
	 * {@link AbstractDescriptor} after calling {@link #persist(Descriptor)} on
	 * it. The method is automatically called if
	 * {@link #find(Class, String, Object)} or
