...
jQAssistant automatically loads YAML files from the following locations (relative to the working directory):

* `.jqassistant.yml` or `.jqassistant.yaml`
* `.yml` or `.yaml` files located in the directory or sub-directory of `.jqassistant/`
