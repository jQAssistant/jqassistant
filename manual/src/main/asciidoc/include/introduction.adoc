...
NOTE: The rule XML schema is available https://jqassistant.github.io/jqassistant/current/schema/jqassistant-rule-v2.8.xsd[online] and should be picked automatically for code completion by your IDE.
