...
public class APOCActivator {
    ...
    private final List<Class<?>> PROCEDURE_TYPES = asList(apoc.algo.Cliques.class, apoc.algo.Cover.class,
            ...
            apoc.cypher.Timeboxed.class, apoc.date.Date.class, apoc.es.ElasticSearch.class, apoc.example.Examples.class, apoc.export.csv.ImportCsv.class,
            apoc.export.Export.class, apoc.export.csv.ExportCSV.class, apoc.export.cypher.ExportCypher.class, apoc.export.graphml.ExportGraphML.class,
            ...
            apoc.log.Logging.class, apoc.math.Regression.class, apoc.merge.Merge.class, apoc.meta.Meta.class, apoc.mongodb.MongoDB.class,
            apoc.monitor.Ids.class, apoc.monitor.Kernel.class, apoc.monitor.Locks.class, apoc.monitor.Store.class, apoc.monitor.Transaction.class,
            apoc.nodes.Grouping.class, apoc.nodes.Nodes.class, apoc.path.PathExplorer.class, apoc.periodic.Periodic.class, apoc.refactor.GraphRefactoring.class,
    ...
    private final List<Class<?>> FUNCTION_TYPES = asList(apoc.algo.Similarity.class, apoc.bitwise.BitwiseOperations.class, apoc.coll.Coll.class,
            ...
            apoc.data.email.ExtractEmail.class, apoc.data.url.ExtractURL.class, apoc.date.Date.class, apoc.diff.Diff.class, apoc.label.Label.class,
            apoc.map.Maps.class, apoc.math.Maths.class, apoc.meta.Meta.class, apoc.nodes.Nodes.class, apoc.number.ArabicRoman.class, apoc.number.Numbers.class,
            apoc.number.exact.Exact.class, apoc.path.Paths.class, apoc.schema.Schemas.class, apoc.scoring.Scoring.class, apoc.text.Strings.class,
            apoc.temporal.TemporalProcedures.class, apoc.trigger.Trigger.class, apoc.util.Utils.class, apoc.version.Version.class);
