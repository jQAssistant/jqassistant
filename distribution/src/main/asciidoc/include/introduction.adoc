...
Specifying a severity for a group applies it to all included elements without further specification of a severity, e.g.
...
Execution of the group 'my-rules:MyGroup' will report a violation of constraint...

- 'my-rules-Constraint1' with severity 'blocker' (inherited from the group)
- 'my-rules-Constraint2' with severity 'minor'
