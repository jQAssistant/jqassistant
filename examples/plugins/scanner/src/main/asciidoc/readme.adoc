...
.pom.xml
----
include::{docRoot}/jqassistant.examples.plugins.scanner/src/pom.xml[lines=11..28,indent=0]
----
...
----
include::{docRoot}/jqassistant.examples.plugins.scanner/src/src/main/java/com/buschmais/jqassistant/examples/plugins/scanner/CSVFileScannerPlugin.java[lines=21..59]
----
