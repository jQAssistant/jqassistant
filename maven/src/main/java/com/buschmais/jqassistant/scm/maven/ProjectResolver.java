...
public final class ProjectResolver {
     ...
     */
    static MavenProject getRootModule(MavenProject module, List<MavenProject> reactor, String rulesDirectory, boolean useReactorAsProjectRoot) throws MojoExecutionException {
     ...
     */
    static Map<MavenProject, List<MavenProject>> getRootModules(List<MavenProject> reactorProjects, String rulesDirectory, boolean useExecutionRootAsProjectRoot) throws MojoExecutionException {
     ...
     * @param rulesDirectory The name of the directory used for identifying the root
     *                       module.
